                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" wire:model.lazy="formDate" class="form-control">
                            @error('formDate') <span class="text-danger">{{$message}}</span>@enderror
                        </div>
                    </div>

                    <div class="col-sm-12 col-md-3 aling-self-center d-flex justify-content-around">
                        @if($userid >0 && $formDate !=null && $toDate !=null)
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        <h5 class="text-white">Ventas: ${{number_format($tota,2)}}</h5>
