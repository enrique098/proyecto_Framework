                ...
                <table class="table-bordered table-hover table striped mt-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0)" class="btn btn-dark mtmobile" title="Editar" wire:click="Edit({{ $coin->id }})">
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        ...
        window.livewire.on('item-deited' , msg =>{
    ...
    function Confirm(id, coins) {
        ...
        if(coins > 0)
        {
            Swal('NO SE PUEDE ELIMINAR LA DENOMINACION PORQUE TIENE PRODUCTOS RELACIONADOS')
            return;
        }
               
        Swal({
            title: 'CONFIRMAR BORRADO',
            text: '¿Está Seguro de Querer Eliminar la denominación Seleccionada?',
            type: 'warning',
