...
<div class="row">
	...
	<div class="col-sm-12 col-md-6">
		...
		<div class="input-group">
			...
			<input type="number" wire:model.lazy="value" class="form-control" placeholder="eje: 100.00" maxlength="25">
		</div>
		@error('vaue') <span class="text-danger er">{{$message}} </span>@enderror
	</div>
	<div class="col-sm-12">
