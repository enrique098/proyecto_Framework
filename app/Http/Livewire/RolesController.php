...
class RolesController extends Component
{
    ...
    public function CreateRole()
    {
        ...
        $messages = [
            ...
            'roleName' => 'El nombre del role debe tener al menos 2 caracteres'
        ];
    ...
    public function Destroy($id)
    {
        ...
        {
            $this->emit('roel-error', 'No se puede eliminar el role porque tiene permisos asociados');
            return;
        }

        Role::find($id)->delete();
        $this->emit('role-deleted', 'Se elimino el role con éxito');
    }
