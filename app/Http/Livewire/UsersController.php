...
class UsersController extends Component
{
    ...
    public function Store()
    {
        ...
        $messages =[
            ...
            'email.unique' => 'El correo ya existe en e sistema',
            'status.required' => 'Selecciona el perfi/role del usuario',
            'status.not_in' => 'Selecciona el status',
            'profile.required' => 'Selecciona el perfil/role del usuario',
            'profile.not_in' => 'Selecciona el perfil/role distinto a Elegir',
